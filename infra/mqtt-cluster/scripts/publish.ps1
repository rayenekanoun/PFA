param(
  [string]$Topic = "cars/demo/commands/diagnostic/request",
  [string]$Message = '{"requestId":"req-001","planId":"plan-001","carId":"demo","type":"diagnostic","correlationId":"corr-001","includeDtcs":true,"timeoutMs":15000,"pids":[{"key":"engine_rpm","mode":"01","pid":"0C"},{"key":"vehicle_speed","mode":"01","pid":"0D"}],"simulate":{"mode":"success"}}',
